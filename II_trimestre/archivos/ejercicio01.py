"""
PROPOSITO:   1. Modifica el ejercicio 1 del tema anterior de manera que:
                ...
                El programa admita dos parámetros:
                    ...
                    El segundo es opcional, y si existe, es el directorio donde vamos a crear un fichero html con la
                    información formateada como una tabla del pronóstico de la temperatura, si no existe la
                    información se muestra por pantalla.
...
def tiempo_en_5dias(ciudad):
    ...
    params = {"q": ciudad, 'APPID':'f13188ece6f3d740bc6070c6c42acef0', "units": "metric", "lang": "es"}
